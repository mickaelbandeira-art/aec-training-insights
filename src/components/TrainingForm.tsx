              ...
              <div className="space-y-4">
                {formOptions.map((option, index) => {
                  ...
                  return (
                    <div 
                      key={option.id}
                      className="flex items-center space-x-4 p-4 rounded-lg border border-border hover:border-secondary hover:bg-muted/50 transition-all duration-300 group animate-slide-in"
                    ...
                    >
                      ...
                      <Label 
                        htmlFor={option.id} 
                        className="text-base font-medium cursor-pointer flex-1 group-hover:text-foreground transition-colors"
                      >
                        {option.label}
                      </Label>
                    </div>
